...
- **What we collect:** User preferences, export settings, and session data
- **How we use it:** To maintain your preferences and restore your work sessions
- **Storage:** Stored locally in Chrome's local storage API
- **Transmission:** Settings are never transmitted to external servers
...
uSampler requires the following permissions:
...
- Data is stored using browser-provided secure storage APIs
- We do not have access to your audio recordings or settings
...
uSampler uses open-source libraries for audio processing. See [Third-Party Licenses](third-party-licenses) for full details. Notable:
...
- Uninstalling the extension (this removes all locally stored data)

## Children's Privacy

uSampler is not intended for users under the age of 13. We do not knowingly collect personal information from children.
...
- Open an issue at [GitHub Issues](https://github.com/JimothySnicket/uSampler/issues)
